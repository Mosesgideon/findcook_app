...
import '../../data/data/repository_impl.dart';
import '../bloc/cook_bloc.dart';
import '../screens/cook_details.dart';
class NonCookwidget extends StatefulWidget {
  const NonCookwidget({super.key});

  @override
  State<NonCookwidget> createState() => _NonCookwidgetState();
}

class _NonCookwidgetState extends State<NonCookwidget> {
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<CookBloc, CookState>(
      bloc: coobloc,
